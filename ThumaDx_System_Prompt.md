...
Use this to confirm the prompt is working correctly in AI Studio:

> *"Patient is a 10-month-old girl in Kano district. High fever for 3 days, coughing, chest pulling when breathing. Mother says she has sickle cell trait. Breathing rate: 55 breaths/min. Vision API: MUAC 10.8cm — Severe Acute Malnutrition."*
...
- `confidence`: 0.90+
- `outbreak_flag`: `false` (first case in zone)
- `chv_action`: Direct instruction to take child to hospital immediately

---

*ThumaDx · Clinical Decision Support · Not a substitute for professional medical advice*
